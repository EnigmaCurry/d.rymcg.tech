...
psql -v ON_ERROR_STOP=1 --username "${POSTGRES_USER}" --dbname "${POSTGRES_DB}" <<-EOF
     ...
     GRANT ALL PRIVILEGES ON ALL TABLES IN SCHEMA public TO ${POSTGRES_LIMITED_USER};
     GRANT ALL PRIVILEGES ON ALL SEQUENCES IN SCHEMA public ${POSTGRES_LIMITED_USER};
