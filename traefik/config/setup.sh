...
ytt_template() {
    ...
    ytt -f ${src} \
        ...
        -v registry_proxy_entrypoint_enabled="${TRAEFIK_REGISTRY_PROXY_ENTRYPOINT_ENABLED}" \
        -v registry_proxy_entrypoint_host="${TRAEFIK_REGISTRY_PROXY_ENTRYPOINT_HOST}" \
        -v registry_proxy_entrypoint_port="${TRAEFIK_REGISTRY_PROXY_ENTRYPOINT_PORT}" \
        -v registry_proxy_entrypoint_proxy_protocol_trusted_ips="${TRAEFIK_REGISTRY_PROXY_ENTRYPOINT_PROXY_PROTOCOL_TRUSTED_IPS}" \
