...
ytt_template() {
    ...
    ytt -f ${src} \
        ...
        -v rtmps_entrypoint_enabled="${TRAEFIK_RTMPS_ENTRYPOINT_ENABLED}" \
        -v rtmps_entrypoint_host="${TRAEFIK_RTMPS_ENTRYPOINT_HOST}" \
        -v rtmps_entrypoint_port="${TRAEFIK_RTMPS_ENTRYPOINT_PORT}" \
        -v rtmps_entrypoint_proxy_protocol_trusted_ips="${TRAEFIK_RTMPS_ENTRYPOINT_PROXY_PROTOCOL_TRUSTED_IPS}" \
