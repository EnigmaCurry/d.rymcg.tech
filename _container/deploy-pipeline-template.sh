...
echo ""
echo "1. Deploy Woodpecker CI and create a 'woodpecker' org on Forgejo:"
echo "     d make woodpecker install"
echo "     https://${REGISTRY}/org/create"
echo ""
echo "2. Create a dedicated Forgejo account for CI (e.g. '${REPO_OWNER}'):"
echo "     https://${REGISTRY}/admin/users"
echo ""
echo "3. Add the CI account to the 'woodpecker' org on Forgejo:"
echo "     https://${REGISTRY}/org/woodpecker/members"
echo ""
echo "4. Add your workstation's SSH public key to the CI account so you can push:"
echo "     Log in as '${REPO_OWNER}' -> https://${REGISTRY}/user/settings/keys"
echo ""
echo "5. Log in to Woodpecker as the CI account and generate an API token:"
echo "     https://woodpecker.example.com/user"
echo ""
echo "=== Next steps ==="
echo ""
echo "  cd ${DEST}"
