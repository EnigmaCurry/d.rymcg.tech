...
## 
## ALIASES=l ROOT_DOMAIN=d.example.com SYSBOX=false bash <(curl -L https://github.com/EnigmaCurry/d.rymcg.tech/blob/master/_scripts/bootstrap_sworkstation.sh?raw=true)
##
...
echo "## Use the '${ALIASES[0]}' alias to manage the local Docker host."
)
