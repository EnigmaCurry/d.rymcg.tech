 ...
 * `docker-compose.override${INSTANCE_SUFFIX}.yaml` (eg.
   `docker-compose.override.yaml` for the default instance, or
   `docker-compose.override_foo.yaml` for the `foo` instance.) This
   should contain the customizied volume mounts. (this is generated by
   the [ytt](https://carvel.dev/ytt/docs/latest/) template
